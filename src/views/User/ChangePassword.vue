    ...
    <div v-else>
      ...
      <div class="hero-banner position-relative">
        <div class="container position-relative" style="z-index: 2">
          <div class="d-flex align-items-end gap-4" style="padding-top: 48px; padding-bottom: 20px">
            <!-- Avatar -->
      ...
      <!-- Form Section (outside hero, on light bg) -->
              ...
              <form @submit.prevent="updatePassword" novalidate>
                <div class="row g-4">
                  ...
                  <div class="col-md-6">
                    ...
                    <div v-if="errors.new_password" class="err-msg">
                      {{ errors.new_password }}
                    </div>
                  </div>
                  ...
                  <div class="col-md-6">
                    ...
                    <div
                      class="input-wrap"
                      :class="{
                        'input-err': errors.confirm_password,
                        'input-locked': !isUnlocked,
                      }"
                    >
              ...
              <div class="side-card-body p-4">
                ...
                <div class="p-3 rounded-3 bg-light border">
                  <p class="small text-muted mb-0">
                    <i class="bi bi-info-circle me-1"></i> បញ្ជាក់ថាវាមិនបានប្រើនៅគេហទំព័រផ្សេងទេ។
                  </p>
                </div>
              </div>
            </div>
