            ...
            <div class="modern-booking-card" @click="openBookingDetail(item)">
              ...
              <div class="content-area">
                ...
                <div class="amenities-summary">
                  ...
                  <div class="amenity">
                    <i class="bi bi-door-open"></i> {{ item.room?.bed }} គ្រែ
                  </div>
                </div>
                  ...
                  <div class="position-absolute top-0 start-0 w-100 h-100 p-5 d-flex flex-column">
                    <div class="mb-auto">
                      <div class="glass-tag mb-3">
                        <span
                          class="status-dot-lg"
                          :class="getStatus(selectedBooking?.status).toLowerCase()"
                        ></span>
                      ...
                      <p class="text-white-50">
                        ...
                        >{{ selectedBooking?.room?.district?.name }}
                      </p>
                    </div>
                ...
                <div class="col-lg-7 bg-white p-4 p-md-5">
                  ...
                  <div class="mb-4">
                    ...
                    <div class="d-flex flex-wrap gap-2">
                      <span
                        v-for="opt in selectedBooking?.room?.options"
                        :key="opt.id"
                        class="amenity-chip"
                      >
                  ...
                  <div class="row g-4 mb-4">
                      ...
                      <div class="payment-card-premium">
                        ...
                        <div class="total-box mt-3">
                          ...
                          <h3 class="text-white mb-0">
                            ${{ (parseFloat(selectedBooking?.room?.price || 0) + 24).toFixed(2) }}
                          </h3>
                        </div>
                      </div>
                    </div>
                    <div class="col-md-5">
                      ...
                      <div class="owner-card-mini">
                        <div class="landlord-avatar-lg">
                          {{ selectedBooking?.seller?.name?.charAt(0) || 'O' }}
                        </div>
                        <h6 class="fw-bold text-navy mb-1">
                          {{ selectedBooking?.seller?.name || 'Owner' }}
                        </h6>
                        <span
                        ...
                        <a
                          v-if="selectedBooking?.room?.map_url"
                          :href="selectedBooking.room.map_url"
                          target="_blank"
                  ...
                  <div class="d-grid">
                    <button class="btn btn-navy-action py-3 rounded-4 fw-bold" @click="closeModal">
                      បិទ
                    </button>
                  </div>
                </div>
